...
/// The starting screen size in the x direction
const int StartXSize = 1250;

/// The starting screen size in the y direction
const int StartYSize = 1250;
...
void MainFrame::Initialize()
{
    Create(nullptr, wxID_ANY, L"UML Wars",
            wxDefaultPosition,  wxSize( StartXSize,StartYSize));
